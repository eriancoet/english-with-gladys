...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation will be updated next to use Links */}
      <Navigation />
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-white mb-4">English with Gladys</h3>
              <p className="text-gray-400 text-sm">
                Professional TEFL instruction for students worldwide.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
            <p>&copy; 2026 English with Gladys. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
